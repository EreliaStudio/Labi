...
int executeGame()
{
    ...
    TextureManager::instance()->add<spk::SpriteSheet>("PlayerSprite", "playerSpriteSheet.png", spk::Vector2Int(4, 4));
    TextureManager::instance()->add<spk::SpriteSheet>("WorldTileset", "worldBackground.png", spk::Vector2Int(16, 24));
